export const LANGS = {
  ru:{
    ...
    ws_contact_terms:"Нажимая «Отправить», вы соглашаетесь с обработкой данных для ответа на обращение.",
    ws_back_choice:"← К кнопкам",
    ws_contact_btn:"Связаться с нами →",
    ws_tab_account:"Аккаунт",
    ws_tab_contact:"Связаться",
    ws_form_mode_aria:"Вход или форма связи",
    ws_subtitle_contact:"Напишите нам — ответим в рабочие часы",
  ...
  en:{
    ...
    ws_contact_terms:"By clicking «Send», you agree to the processing of your data to respond to your request.",
    ws_back_choice:"← Back to options",
    ws_contact_btn:"Contact us →",
    ws_tab_account:"Account",
    ws_tab_contact:"Contact",
    ws_form_mode_aria:"Sign in or contact form",
    ws_subtitle_contact:"Write to us — we reply during business hours",
  ...
  uz:{
    ...
    ws_contact_terms:"«Yuborish» tugmasini bosish orqali murojaatingizga javob berish uchun ma'lumotlaringizni qayta ishlashga rozilik bildirasiz.",
    ws_back_choice:"← Tugmalarga qaytish",
    ws_contact_btn:"Biz bilan bog'lanish →",
    ws_tab_account:"Hisob",
    ws_tab_contact:"Aloqa",
    ws_form_mode_aria:"Kirish yoki aloqa formasi",
    ws_subtitle_contact:"Yozing — ish soatlarida javob beramiz",
    contact_badge:"Aloqa",
